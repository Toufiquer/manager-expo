/*
|-----------------------------------------
| setting up FirstUi for the App
| @author: Toufiquer Rahman<toufiquer.0@gmail.com>
| @copyright: manager expo, June, 2024
|-----------------------------------------
*/
...
import { Fonts } from "@/components/utils/CustomFonts";
...
const FirstUi = ({ setShowUI, handleCancel, setCurrentUIData }) => {
                ...
                <View>
                  {subItems.map((item, idx) => (
                    <View key={item.id || "" + idx}>
                      ...
                      <View>
                        {item.item === uiOptions.title && (
                          <View className="flex flex-row flex-wrap gap-2">
                            {uiOptions.data.map((item) => (
                              <View className="rounded-lg border border-gray-400  p-2 ">
                                {(item.name || item.optionFor) && (
